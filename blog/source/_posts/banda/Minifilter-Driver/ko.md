---
title: "[Research] 걸어서 Windows Minifilter Driver 속으로(KR)"
author: banda
...
안녕하세요, banda입니다. Windows Minifilter Driver 글과 함께 처음 인사드립니다. 🤗
...
마무리는 제가 `cldflt.sys`의 Minifilter 드라이버 특성, 그리고 WNF + ALPC 기법을 통해 구현한 LPE 결과를 보여드리며 끝내도록 하겠습니다. Minifilter을 공부하면서 느낀 점은.. 동작 방식이나 함수, 개념 자체는 조금 생소할 수도 있지만, 결국에 취약점이 트리거되는 방식이나 루트 커즈 원리는 비슷비슷하다는 생각이 들었네요… 그러니 Minifilter 진입에 너무 겁 먹지 않으셔도 될 것 같습니다!!

다음에도 기회가 된다면 아직 공부해보지 않은 다양한 드라이버를 공부해보고 싶네요.. 다음 글도 많은 기대 부탁드립니다!
